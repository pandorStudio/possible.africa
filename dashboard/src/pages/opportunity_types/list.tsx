...
export const OpportunityTypeList: React.FC<IResourceComponentsProps> = () => {
      ...
      async onOk(...args) {
        if (checkedArray.length) {
          const results = checkedArray.map(async (ob) => {
            return axiosInstance.delete(apiUrl + `/opportunity_types/${ob}`, {
              headers: {
                "Content-Type": "application/json",
              },
            });
                  ...
                  onClick={() => {
                    ...
                    if (tableProps?.dataSource) {
                      ...
                      if (data) {
                        ...
                        a.setAttribute(
                          "download",
                          `opportunity_types-${new Date()}-${Math.round(
