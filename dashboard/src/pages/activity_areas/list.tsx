...
export const ActivityAreaList: React.FC<IResourceComponentsProps> = () => {
      ...
      async onOk(...args) {
        if (checkedArray.length) {
          const results = checkedArray.map(async (ob) => {
            return axiosInstance.delete(apiUrl + `/activity_areas/${ob}`, {
              headers: {
                "Content-Type": "application/json",
              },
            });
                  ...
                  onClick={() => {
                    ...
                    if (tableProps?.dataSource) {
                      ...
                      if (data) {
                        ...
                        a.setAttribute(
                          "download",
                          `organisation_types-${new Date()}-${Math.round(
